					...
					{list.map((info, key) => (
						<View>
							...
							<Popover
								from={
									<TouchableOpacity>
										<Text className="text-center font-pbold text-emerald-900 m-5">
											Know more.
										</Text>
									</TouchableOpacity>
								}
							>
								<Text>
									<Text> Hi! This is a/an plant. </Text>
									<Text> This plant is {info['cycle']}. </Text>
									<Text> I need {info['watering']} watering. </Text>
									<Text> As for sunlight, I need . </Text>
									{/* <Text>
										{" "}
										I have a {card.anatomy[0].bark} bark and{" "}
										{card.anatomy[1].leaves} leaves.
									</Text> */}
									{/* <Text>
										{" "}
										I do {!card.flowers && <Text>not</Text>} bear flowers.{" "}
									</Text>
									<Text>
										{" "}
										I do {!card.fruits && <Text>not</Text>} bear fruits.{" "}
									</Text>
